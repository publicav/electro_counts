<div id="edit_counter" style="display:none;">
    <form id="edit_value_counts_form" name="add_value_form" method="post" action="ajax/actionform_edit_value/">
		...
		<div class="p_input"><div class="label_p"><label for="substation_edit">Подстанция</label></div><select  id="substation_edit" class="input_selected" name="substation_edit"></select></div>
		<div class="p_input"><div class="label_p"><label for="counter_edit">Ячейка</label></div><select id="counter_edit" class="input_selected" name="counter_edit"></select></div>
        ...
        <div class="p_input">
            ...
            <input id="counter_val_edit"   class="input_form" name="counter_val"/>
        </div>
