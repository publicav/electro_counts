<div id="edit_counter" style="display:none;">
    <form id="edit_value_counts_form" name="add_value_form" method="post" action="models/json/add_value_counts.php">     
		...
		<div class="p_input"><div class="label_p"><label for="path_name"> Время замера</label></div><input type="text"  class="input_date_b" id="date_airing_begin_edit"  name="date_begin" value="<?php echo  date("d-m-Y");;?>"/><input   class="input_time_b" id="time_airing_begin_edit" type="time" name="time_begin"/></div>
